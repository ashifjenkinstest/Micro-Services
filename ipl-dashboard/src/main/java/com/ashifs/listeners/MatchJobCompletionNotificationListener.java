...
public class MatchJobCompletionNotificationListener extends JobExecutionListenerSupport {
  ...
  @Autowired
  public MatchJobCompletionNotificationListener(EntityManager entityManager) {
  ...
  public void afterJob(JobExecution jobExecution) {
    if (jobExecution.getStatus() == BatchStatus.COMPLETED) {
      ...
      entityManager
          .createQuery("SELECT M.winner,COUNT(*) FROM MATCH M  where M.winner!='NA' GROUP BY M.winner", Object[].class)
