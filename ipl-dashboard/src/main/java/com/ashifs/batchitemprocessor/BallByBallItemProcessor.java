...
public class BallByBallItemProcessor implements ItemProcessor<BallByBallInput, BallByBall> {
    ...
    public BallByBall process(BallByBallInput ballByBallInput) throws Exception {
        ...
        final Long ball = Long.parseLong(ballByBallInput.getOver());
        ...
        final String battingTeam = ballByBallInput.getBattingTeam().toUpperCase();
        final String bowlingTeam = ballByBallInput.getBowlingTeam().toUpperCase();
